...
public class ChordRelationshipTests
{
    [Fact]
    public void Analysis_Test()
    {
        ...
        var relationship = new ChordRelationship(gMajorChord, cMajorChord);
    ...
    public void BestKeys_Multiple_Test()
    {
        ...
        var gMajorChord = new Chord(Pitches.GNatural, ChordQualities.Maj);
        var relationship = new ChordRelationship(aMinorChord, gMajorChord);
    ...
    public void BestKeys_Single_Test()
    {
        ...
        var relationship = new ChordRelationship(aDom7, dMin7);
