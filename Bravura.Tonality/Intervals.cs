...
namespace Bravura.Tonality
{
    public static class Intervals
    {
        static Intervals()
        {
            PerfectUnison = new Interval(0, Accidentals.Natural, 0, IntervalNames.PerfectUnison, IntervalSymbols.PerfectUnison);
            AugmentedUnison = new Interval(1, Accidentals.Sharp, 0, IntervalNames.AugmentedUnison, IntervalSymbols.AugmentedUnison);
            DiminishedSecond = new Interval(0, Accidentals.DoubleFlat, 1, IntervalNames.DiminishedSecond, IntervalSymbols.DiminishedSecond);
            MinorSecond = new Interval(1, Accidentals.Flat, 1, IntervalNames.MinorSecond, IntervalSymbols.MinorSecond);
            MajorSecond = new Interval(2, Accidentals.Natural, 1, IntervalNames.MajorSecond, IntervalSymbols.MajorSecond);
            AugmentedSecond = new Interval(3, Accidentals.Sharp, 1, IntervalNames.AugmentedSecond, IntervalSymbols.AugmentedSecond);
            DiminishedThird = new Interval(2, Accidentals.DoubleFlat, 2, IntervalNames.DiminishedThird, IntervalSymbols.DiminishedThird);
            MinorThird = new Interval(3, Accidentals.Flat, 2, IntervalNames.MinorThird, IntervalSymbols.MinorThird);
            MajorThird = new Interval(4, Accidentals.Natural, 2, IntervalNames.MajorThird, IntervalSymbols.MajorThird);
            AugmentedThird = new Interval(5, Accidentals.Sharp, 2, IntervalNames.AugmentedThird, IntervalSymbols.AugmentedThird);
            DiminishedFourth = new Interval(4, Accidentals.Flat, 3, IntervalNames.DiminishedFourth, IntervalSymbols.DiminishedFourth);
            PerfectFourth = new Interval(5, Accidentals.Natural, 3, IntervalNames.PerfectFourth, IntervalSymbols.PerfectFourth);
            AugmentedFourth = new Interval(6, Accidentals.Sharp, 3, IntervalNames.AugmentedFourth, IntervalSymbols.AugmentedFourth);
            Tritone = new Interval(6, Accidentals.Sharp, 3, IntervalNames.Tritone, IntervalSymbols.Tritone);
            DiminishedFifth = new Interval(6, Accidentals.Flat, 4, IntervalNames.DiminishedFifth, IntervalSymbols.DiminishedFifth);
            PerfectFifth = new Interval(7, Accidentals.Natural, 4, IntervalNames.PerfectFifth, IntervalSymbols.PerfectFifth);
            AugmentedFifth = new Interval(8, Accidentals.Sharp, 4, IntervalNames.AugmentedFifth, IntervalSymbols.AugmentedFifth);
            DiminishedSixth = new Interval(7, Accidentals.DoubleFlat, 5, IntervalNames.DiminishedSixth, IntervalSymbols.DiminishedSixth);
            MinorSixth = new Interval(8, Accidentals.Flat, 5, IntervalNames.MinorSixth, IntervalSymbols.MinorSixth);
            MajorSixth = new Interval(9, Accidentals.Natural, 5, IntervalNames.MajorSixth, IntervalSymbols.MajorSixth);
            AugmentedSixth = new Interval(10, Accidentals.Sharp, 5, IntervalNames.AugmentedSixth, IntervalSymbols.AugmentedSixth);
            DiminishedSeventh = new Interval(9, Accidentals.DoubleFlat, 6, IntervalNames.DiminishedSeventh, IntervalSymbols.DiminishedSeventh);
            MinorSeventh = new Interval(10, Accidentals.Flat, 6, IntervalNames.MinorSeventh, IntervalSymbols.MinorSeventh);
            MajorSeventh = new Interval(11, Accidentals.Natural, 6, IntervalNames.MajorSeventh, IntervalSymbols.MajorSeventh);
            AugmentedSeventh = new Interval(12, Accidentals.Sharp, 6, IntervalNames.AugmentedSeventh, IntervalSymbols.AugmentedSeventh);
            DiminishedOctave = new Interval(11, Accidentals.Flat, 7, IntervalNames.DiminishedOctave, IntervalSymbols.DiminishedOctave);
            PerfectOctave = new Interval(12, Accidentals.Natural, 7, IntervalNames.PerfectOctave, IntervalSymbols.PerfectOctave);
